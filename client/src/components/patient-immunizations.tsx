...
import { Syringe, Plus, Trash, Edit, Calendar, CheckCircle, Clock, FileText, ExternalLink } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4">
          {immunizations.map((vaccine: any) => (
            <Card key={vaccine.id} className={`border-l-4 ${
