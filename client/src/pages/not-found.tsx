...
const availableRoutes = [
  ...
  { path: "/wellness", name: "Wellness Center", description: "Patient wellness programs" },
  { path: "/wellness/plans", name: "Wellness Plans", description: "Personalized wellness plans" },
